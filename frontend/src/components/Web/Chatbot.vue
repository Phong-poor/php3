    ...
    <div v-else class="chat-window" :class="{ minimized: isMinimized }">
        ...
        <div class="chat-header">
            ...
            <div class="header-actions">
                <button class="hdr-btn" @click="isMinimized = !isMinimized"
        ...
        <template v-if="!isMinimized">
                ...
                <div v-for="msg in messages" :key="msg.id" class="msg-group" :class="msg.from">
                    ...
                    <div class="msg-content">
                        ...
                        <div v-if="msg.showQuick" class="quick-replies">
                            <button v-for="q in quickReplies" :key="q" class="quick-btn" @click="sendMessage(q)">{{ q
                                }}</button>
                        </div>
                    </div>
            ...
            <div class="chat-input-wrap">
                <div class="input-row">
                    <input v-model="inputText" @keydown="onKeydown" placeholder="Nhập tin nhắn..."
                        :disabled="isTyping" />
